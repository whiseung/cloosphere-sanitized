...
class ERROR_MESSAGES(str, Enum):
    ...
    PASSWORD_TOO_WEAK = "Password does not meet the minimum requirements. It must be at least 8 characters long and include at least one uppercase letter, one lowercase letter, and one number."
    ...
    NAME_TAKEN = "Uh-oh! This name is already registered. Please choose another name."
    ...
    DOCUMENT_EXTRACTION_EMPTY = (
        "Document extraction returned empty content. "
        "If this is a scanned PDF, OCR processing is required. "
        "If you are using an LLM Vision profile, check the backend logs "
        "for 'LLM Vision extraction failed' entries."
    )
