...
class Instrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        # Process runtime metrics (CPU, memory, threads, GC)
        # system.* metrics are excluded — unreliable in containers
        try:
            ...
            logger.warning("[Telemetry] Failed to instrument system metrics")
