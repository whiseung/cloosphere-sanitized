...
import pandas as pd
from extension_modules.dbsphere_back.tools.chart_generator import (
    ChartType,
...
class VisualizeDataArgs(BaseModel):
    ...
    chart_type: ChartType = Field(
        ...
        description=(
            ...
            "Only use a specific chart type if the user explicitly mentions it. "
            "Otherwise, MUST use 'auto' and MUST NOT infer or assume any chart type."
        ),
    )
