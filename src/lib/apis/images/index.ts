...
export const getImageConnectionsConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${IMAGES_API_BASE_URL}/connections/config`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateImageConnectionsConfig = async (token: string, config: object) => {
	let error = null;

	const res = await fetch(`${IMAGES_API_BASE_URL}/connections/config/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getImageConnectionsList = async (token: string) => {
	let error = null;

	const res = await fetch(`${IMAGES_API_BASE_URL}/connections/list`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
