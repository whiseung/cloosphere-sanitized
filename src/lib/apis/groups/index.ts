...
export const getGroupMemberEmails = async (token: string, id: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/id/${id}/member-emails`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getGroupsByIds = async (token: string, ids: string[]) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/names`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getGroupUsageLimit = async (token: string, groupId: string) => {
	let error = null;
	const res = await fetch(`${WEBUI_API_BASE_URL}/groups/id/${groupId}/usage-limit`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateGroupUsageLimit = async (
	token: string,
	groupId: string,
